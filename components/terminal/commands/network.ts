...
export const networkCommands: Record<string, CommandHandler> = {
  ...
  curl: () => [
    ...
    L("x-cache: HIT", col.green),
    L("x-request-id: rm::1337-1234567890", col.fg),
  ...
  whois: () => [
    ...
    L("  Name Servers:  ns1.cloudflare.com, ns2.cloudflare.com", col.fg),
  ...
  traceroute: () => [
    ...
    L(" 5  cdn-edge (76.76.21.1)              14.2 ms", col.fg),
