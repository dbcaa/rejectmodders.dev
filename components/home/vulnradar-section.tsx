...
const features = [
  { icon: FileSearch, label: "310+ Vulnerability Checks", desc: "SQLi, XSS, SSRF, open redirects, misconfigs and more" },
...
const lines = [
  ...
  { text: "  Running 310 vulnerability checks",              color: "text-muted-foreground" },
  { text: "",                                                 color: "" },
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          >
            ...
            <div className="mt-8 grid gap-3 sm:grid-cols-2">
              {features.map((f, i) => (
                <motion.div
                  ...
                  initial={false}
                  animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 16 }}
                  transition={{ duration: DUR, delay: 0.1 + i * 0.05, ease: EASE }}
            ...
            <motion.div
              initial={false}
              animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 16 }}
              transition={{ duration: DUR, delay: 0.3, ease: EASE }}
          ...
          <motion.div
            ...
            transition={{ duration: DUR, delay: 0.15, ease: EASE }}
          >
