...
export function ContactSection() {
  ...
  return (
    <section ref={ref} id="contact" className="relative py-16 sm:py-24 md:py-32 scroll-mt-24">
      {/* Ambient orbs */}
      <motion.div
        initial={false}
        ...
        >
          ...
          <div className="relative grid gap-8 md:grid-cols-2 md:gap-10">
            ...
            <motion.div
              initial={false}
              animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 12 }}
              transition={{ duration: DUR, delay: 0.25, ease: EASE }}
            ...
            <div className="flex flex-col gap-3">
              <motion.p
                ...
                transition={{ duration: DUR, delay: 0.25 }}
